...
/**
 * Control Panel for MultiRecognizer's parameters
 * Code adapted from ELAN's DemoRecognizerPanel
 */
@SuppressWarnings("serial")
public class MultiRecognizerPanel extends JPanel implements ChangeListener, ParamPreferences {
	 ...
	 * Constructor 
	 */
	public MultiRecognizerPanel(AbstractSelectionPanel selectionPanel, RecognizerHost host) {
